...
- [x] We need font support for main menu - this will propagate down to all menus items and submenus for now **!!DONE!!**
...
- [x] clicking "Apply Changes" button in property panel should automatically rebuild the menu instead of having to click apply changes then save.
  - DONE: Apply Changes now automatically calls Save_Click() to persist changes and rebuild menu